...
const concatenarArrays = (arr1, arr2) => {
  const arrayConcatenado = [...new Set(arr1.concat(arr2))];
...
const sumarNumeros = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    // Se debe sumar el valor del array en lugar del índice
    total += arr[i];
  }
  return total;
};
...
// Nota: En la línea total += arr[i];, ahora se suma el valor del array en la posición i en lugar de simplemente el índice i. Esto corregirá la función para que sume los valores correctos del array.
